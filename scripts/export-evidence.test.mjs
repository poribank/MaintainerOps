...
import { getJson, normalizeBaseUrl, parseArgs, renderMarkdown } from "./export-evidence.mjs";
...
describe("export-evidence script helpers", () => {
  ...
  it("parses flag arguments and normalizes base URLs", () => {
  ...
  it("renders evidence markdown with pilot metrics and GitHub App permissions", () => {
    const markdown = renderMarkdown({
      generatedAt: "2026-06-05T00:00:00.000Z",
      baseUrl: "http://localhost:3001",
      readyz: { store: "memory", queue: "memory" },
      githubAppPermissions: {
        minimum: { metadata: "read", contents: "read", checks: "write" },
        optional: { contents: "write for release drafts only" }
      },
      queue: {
        items: [
          {
