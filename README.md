...
The public `v0.2.3` GitHub Release includes workspace tarballs, a CycloneDX SBOM, and `SHA256SUMS` for pilot inspection. npm package publishing and container registry publishing are still intentionally not configured by default. See [docs/RELEASE_RUNBOOK.md](docs/RELEASE_RUNBOOK.md).
